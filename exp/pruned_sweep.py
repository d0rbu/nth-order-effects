...
from exp.pruned import main as pruned_main
from exp.exp_data import get_exp_data, ExperimentConfig, PRUNED_OUT_SUBDIR
...
def sweep(
    *args,
    ...
    completed_experiments = set(get_exp_data(out_dir, PRUNED_OUT_SUBDIR).keys())
